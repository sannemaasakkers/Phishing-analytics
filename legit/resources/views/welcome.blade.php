  ...
  <header class="jumbotron my-4" style="background: url(img/banner2.png); background-size: 100% 115%; background-position: center;">
    <div class="row">
      <div class="col-md-6 col-lg-6">
        ...
        <p class="lead" style="color: white;">We have the new iPhone X back in stock. <br>Different colours and models available.<BR><BR></p>
        ...
        <div class="col-lg-4 col-md-12 mb-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Does your phone have problems? We can repair these within 3 working days. Our customers gave us an 8 for service!</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-12 mb-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Next day delivery when ordered before 22.00! After ordering you will immediately receive a track and trace code.</p>
            </div>
          </div>
        </div>
